    ...
    namespace calendar {
        namespace v3 {
            export interface Calendar {
                ...
                'acl': {
                    'delete': (parameters: {'calendarId': string, 'ruleId': string}, callback: (error: any, body: any, response: any) => void) => Request;
                    'get': (parameters: {'calendarId': string, 'ruleId': string}, callback: (error: any, body: AclRule, response: any) => void) => Request;
                    'insert': (parameters: {'calendarId': string}, callback: (error: any, body: AclRule, response: any) => void) => Request;
                    'list': (parameters: {'calendarId': string, 'maxResults'?: number, 'pageToken'?: string, 'showDeleted'?: boolean, 'syncToken'?: string}, callback: (error: any, body: Acl, response: any) => void) => Request;
                    'patch': (parameters: {'calendarId': string, 'ruleId': string}, callback: (error: any, body: AclRule, response: any) => void) => Request;
                    'update': (parameters: {'calendarId': string, 'ruleId': string}, callback: (error: any, body: AclRule, response: any) => void) => Request;
                    'watch': (parameters: {'calendarId': string, 'maxResults'?: number, 'pageToken'?: string, 'showDeleted'?: boolean, 'syncToken'?: string}, callback: (error: any, body: Channel, response: any) => void) => Request;
                };
                'calendarList': {
                ...
                'calendars': {
                    ...
                    'patch': (parameters: {'calendarId': string}, callback: (error: any, body: Calendar, response: any) => void) => Request;
                    'update': (parameters: {'calendarId': string}, callback: (error: any, body: Calendar, response: any) => void) => Request;
                };
                'channels': {
                ...
                'events': {
                    ...
                    'patch': (parameters: {'alwaysIncludeEmail'?: boolean, 'calendarId': string, 'eventId': string, 'maxAttendees'?: number, 'sendNotifications'?: boolean, 'supportsAttachments'?: boolean}, callback: (error: any, body: Event, response: any) => void) => Request;
                    'quickAdd': (parameters: {'calendarId': string, 'sendNotifications'?: boolean, 'text': string}, callback: (error: any, body: Event, response: any) => void) => Request;
                    'update': (parameters: {'alwaysIncludeEmail'?: boolean, 'calendarId': string, 'eventId': string, 'maxAttendees'?: number, 'sendNotifications'?: boolean, 'supportsAttachments'?: boolean}, callback: (error: any, body: Event, response: any) => void) => Request;
                    'watch': (parameters: {'alwaysIncludeEmail'?: boolean, 'calendarId': string, 'iCalUID'?: string, 'maxAttendees'?: number, 'maxResults'?: number, 'orderBy'?: string, 'pageToken'?: string, 'privateExtendedProperty'?: string, 'q'?: string, 'sharedExtendedProperty'?: string, 'showDeleted'?: boolean, 'showHiddenInvitations'?: boolean, 'singleEvents'?: boolean, 'syncToken'?: string, 'timeMax'?: string, 'timeMin'?: string, 'timeZone'?: string, 'updatedMin'?: string}, callback: (error: any, body: Channel, response: any) => void) => Request;
                };
                'freebusy': {
                    'query': (parameters: any, callback: (error: any, body: FreeBusyResponse, response: any) => void) => Request;
                };
                'settings': {
                    'get': (parameters: {'setting': string}, callback: (error: any, body: Setting, response: any) => void) => Request;
                    'list': (parameters: {'maxResults'?: number, 'pageToken'?: string, 'syncToken'?: string}, callback: (error: any, body: Settings, response: any) => void) => Request;
                    'watch': (parameters: {'maxResults'?: number, 'pageToken'?: string, 'syncToken'?: string}, callback: (error: any, body: Channel, response: any) => void) => Request;
                };
